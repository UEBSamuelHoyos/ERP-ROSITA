...
public class ClienteServiceImpl implements ClienteService {
    ...
    public ClientesDTO saveCliente(ClientesDTO ClientesDTO) {
        ...
        cliente.setDescuentoAplicado(ClientesDTO.isDescuentoAplicado()); // Nuevo campo
        ...
        savedDTO.setDescuentoAplicado(saved.isDescuentoAplicado()); // Nuevo campo
    ...
    public ClientesDTO updateCliente(Long id, ClientesDTO dto) {
        return clienteRepository.findById(id).map(cliente -> {
            ...
            cliente.setDescuentoAplicado(dto.isDescuentoAplicado()); // Nuevo campo
    ...
    private ClientesDTO mapToDTO(Cliente cliente) {
        ...
        dto.setDescuentoAplicado(cliente.isDescuentoAplicado()); // Nuevo campo
        return dto;
    }
